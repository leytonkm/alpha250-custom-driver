/// Laser Current Ramp Driver
///
/// Driver for controlling the laser current ramp (temperature and laser power)
/// (c) Koheron
...
class VoltageControl
{
  public:
    ...
    void set_laser_power_voltage(float voltage) {
    ...
    void enable_laser_output(bool enable) {
